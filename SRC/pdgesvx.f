...
*
      IF( SCALAPACK_CONTEXT%IS_LOG_ENABLED.EQ.1 ) THEN
         WRITE(LOG_BUF,102)  EQUED, FACT, TRANS, IA, IAF,
     $            IB, INFO, IX, JA, JAF, JB, JX, LIWORK,
     $                              LWORK, N, NRHS,
     $            RCOND, NPROW, NPCOL, MYROW, MYCOL,
     $            eos_str
 102     FORMAT('PDGESVX inputs:,EQUED:',A5,',FACT:',A5,
     $           ',TRANS:',A5,',IA:',I5,',IAF:',I5,',IB:',I5,
     $           ',INFO:',I5,',IX:',I5,',JA:',I5,
     $           ',JAF:',I5,',JB:',I5,',JX:',I5,
     $           ',LIWORK:',I5,',LWORK:',I5,',N:',I5,
     $           ',NRHS:',I5,',RCOND:',F9.4,',NPROW:',I5,
