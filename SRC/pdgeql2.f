...
*     .. DTL variables declaration ..
      ...
      CHARACTER*15, PARAMETER :: FILE_NAME = 'pdgeql2.f'
...
*
      IF( SCALAPACK_CONTEXT%IS_LOG_ENABLED.EQ.1 ) THEN
         WRITE(LOG_BUF,102)  IA, INFO, JA, LWORK, M, N, NPROW,
     $            NPCOL, MYROW, MYCOL, eos_str
 102     FORMAT('PDGEQL2 inputs:,IA:',I5,',INFO:',I5,',JA:',I5,
     $           ',LWORK:',I5,',M:',I5,',N:',I5,
