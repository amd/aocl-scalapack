...
*     .. DTL variables declaration ..
      ...
      CHARACTER*15, PARAMETER :: FILE_NAME = 'pddttrsv.f'
...
*        .. Init DTL log Buffer to zero ..
         ...
         WRITE(BUFFER,102)  TRANS, UPLO, IB, INFO,
     $ JA, LAF, LWORK, N, NRHS
 102     FORMAT('PDDTTRSV inputs:
     $ TRANS: ', A5,'  UPLO: ', A5,'
...
*
      IF( SCALAPACK_CONTEXT%IS_LOG_ENABLED.EQ.1 ) THEN
         WRITE(LOG_BUF,102)  TRANS, UPLO, IB, INFO, JA, LAF,
     $            LWORK, N, NRHS, NPROW, NPCOL, MYROW,
     $            MYCOL, eos_str
 102     FORMAT('PDDTTRSV inputs:,TRANS:',A5,',UPLO:',A5,
     $           ',IB:',I5,',INFO:',I5,',JA:',I5,',LAF:',I5,
