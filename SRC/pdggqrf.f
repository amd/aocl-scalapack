...
*     .. DTL variables declaration ..
      ...
      CHARACTER*15, PARAMETER :: FILE_NAME = 'pdggqrf.f'
...
*
      IF( SCALAPACK_CONTEXT%IS_LOG_ENABLED.EQ.1 ) THEN
         WRITE(LOG_BUF,102)  IA, IB, INFO, JA, JB, LWORK,
     $            M, N, P, NPROW, NPCOL, MYROW, MYCOL,
     $            eos_str
 102     FORMAT('PDGGQRF inputs:,IA:',I5,',IB:',I5,',INFO:',I5,
     $           ',JA:',I5,',JB:',I5,',LWORK:',I5,
     $           ',M:',I5,',N:',I5,',P:',I5,',NPROW:',I5,
     $           ',NPCOL:',I5 ,',MYROW:',I5,
     $           ',MYCOL:',I5,A5)
