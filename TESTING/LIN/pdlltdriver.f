...
*                    If PDPOTRF is returning correct error code, do nothing
                     WRITE( NOUT, FMT = 9983 ) 'PDPOTRF'
                  ELSE IF (INFO.GT.0 .AND. EX_FLAG)  THEN
                     WRITE(*,*) 'PDPOTRF INFO=', INFO
...
*                          we need to pass this case
                           WRITE( NOUT, FMT = 9983 ) 'PDPOTRS'
                        ELSE IF( INFO .GT. 0 .AND. EX_FLAG) THEN
                              WRITE(*,*) 'PDPOTRS INFO=', INFO
...
*
 ...
 9993 FORMAT( A4, 4X, A1, 1X, I5, 1X, I5, 1X, I4, 1X, I5, 1X, I4, 1X,
     $        I4, 1X, F8.2, 1X, F8.2, 1X, F12.2, 1X, A6 )
