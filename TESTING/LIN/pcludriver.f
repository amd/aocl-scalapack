...
*
                        IF( INFO.NE.0 ) THEN
                           IF( IAM.EQ.0 )
     $                        WRITE( NOUT, FMT = * ) 'PCGETRS INFO=',
     $                                             INFO
*                          If NRHS < 0 in LU.dat file then
*                          PCGETRS API sets INFO = -3
...
*
 ...
 9994 FORMAT( '---- ----- ----- --- ---- ----- ---- ---- -------- ',
     $        '-------- -------- ------' )
 9993 FORMAT( A4, 1X, I5, 1X, I5, 1X, I5, 1X, I5, 1X, I4, 1X, I4, 1X,
