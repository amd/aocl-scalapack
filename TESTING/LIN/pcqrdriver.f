...
*
     ...
     $                                  MEM( IPPIV-IPREPAD ), LIPIV,
     $                                  IPREPAD, IPOSTPAD, PADVAL )
                           CALL PCCHEKPAD( ICTXT, ROUT,
     $                                  WORKRFCT-IPOSTPAD, 1,
     $                                  MEM( IPRW-IPREPAD ),
     $                                  WORKRFCT-IPOSTPAD,
     $                                  IPREPAD, IPOSTPAD, PADVAL )
                        END IF
                        CALL PCCHEKPAD( ICTXT, ROUT, WORKFCT-IPOSTPAD,
     $                               1, MEM( IPW-IPREPAD ),
