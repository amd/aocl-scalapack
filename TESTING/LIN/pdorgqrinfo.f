      SUBROUTINE PDORGQRINFO( SUMMRY, NOUT, NMAT, MVAL,
     $                     LDMVAL, NVAL, LDNVAL, NNB, MBVAL,
...
*
*     .. Scalar Arguments ..
      INTEGER            IAM, LDMBVAL, LDMVAL, LDNBVAL, LDNVAL,
     $                   LDPVAL, LDQVAL, NGRIDS, NMAT, NNB,
     $                   NPROCS, NOUT
      REAL               THRESH
*     ..
*     .. Array Arguments ..
...
*
         OPEN( NIN, FILE='OQR.dat', STATUS='OLD' )
         READ( NIN, FMT = * ) SUMMRY
         SUMMRY = ' '
*
...
*
         WRITE( NOUT, FMT = 9999 )
     $               'ScaLAPACK Orthogonal factorizations routine'
