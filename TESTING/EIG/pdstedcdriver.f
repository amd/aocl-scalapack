...
*     ============
*
*     This routine tests PDSTEDC, the expert driver for the parallel
*     symmetric eigenvalue problem, PDSTEDC and PDSTEDC.  We would like
...
*
*     As PDSTEDC returns an error message when heterogeneity is detected,
*     the PDSTEDC tests can be suppressed by changing the appropiate
...
*
     ...
     $                   IGAMN2D, PDLACHKIEEE, PDLASNBT, PDSTEDCREQ 
*     ..
...
*
         OPEN( UNIT = NIN, FILE = 'STED.dat', STATUS = 'OLD' )
         READ( NIN, FMT = * )SUMMRY
         SUMMRY = ' '
*
...
*
     ...
     $      'symmetric eigenvalue routine:  PDSTEDC & '//
     $       ' PDSTEDC & PDSTEDC.'
     ...
     $      'reorthogonalized for lack of workspace.'
         WRITE( NOUT, FMT = 9999 )
     $      'TYP      : matrix type (see PDSTEDCtst.f).'
     ...
     $      'eigen request tests'
         WRITE( NOUT, FMT = 9999 )
     $      'TEST     : EVX - testing PDSTEDC, EV - testing PDSTEDC, '//
     $        'EVD - testing PDSTEDC'
         WRITE( NOUT, FMT = 9999 )' '
      END IF
*
...
*
      ...
      ISEED( 4 ) = 3139
*
      CALL PDSTEDCREQ( HETERO, NIN, MEM, MEMSIZ, NOUT, ISEED, NTESTS,
