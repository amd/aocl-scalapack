...
*
            DO 50 I = 1, N
               WORK( INDD+I-1 ) = ZERO
   50       CONTINUE
            CALL PSLASET( 'All', N, N, ZERO, ZERO,
     $                    COPYA, 1, 1, DESCA )
            WKNOWN = .TRUE.
*
...
*
            ...
            CALL PSMATGEN( DESCA( CTXT_ ), 'S', 'N', N,
     $                     N, DESCA( MB_ ),
...
*
         ...
         VU = -ONE
*
         CALL PSLASIZESYEVX( WKNOWN, 'A', N, DESCA, VL, VU,
     $                       IL, IU,
...
*
            IF(N .LT. 0 .AND. INFO .EQ. -3) THEN
             ...
             INFO = 1
            ELSE
              CALL PSSQPSUBTST( WKNOWN, JOBZ, UPLO, N, THRESH, ABSTOL,
...
*
 ...
 9979 FORMAT( 'N < 0, negative test case detected for PSSYEV with'
