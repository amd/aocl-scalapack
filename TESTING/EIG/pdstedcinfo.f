*
*
      SUBROUTINE PDSTEDCINFO( CONTEXT, IAM, NIN, NOUT, MAXSETSIZE,
...
*  =======
*
*  PDSTEDCINFO reads the input test data file (INFILE), copies the
...
*             Refer to PDSTEDCTST for a complete description of the
...
*
*           If ( ABSTOL .EQ. 0 in STED.dat, it is set to
