...
#else
      INTEGER            DBLESZ, TOTMEM, ZPLXSZ, NTESTS
	  INTEGER, PARAMETER ::  MEMSIZ = 210000000
      COMPLEX*16         PADVAL
      PARAMETER          ( DBLESZ = 8, TOTMEM = 80000000, ZPLXSZ = 16,
     $                   NTESTS = 20,
     $                   PADVAL = ( -9923.0D+0, -9923.0D+0 ) )
#endif
*     ..
...
*
 ...
 9994 FORMAT( '---- ---- ------ --- ----- ----- --------- ',
     $      '----------- -------- ------' )
 9993 FORMAT( A4, 1X, A4, 1X, I6, 1X, I5, 1X, I5, 1X, I5, 1X, F9.2, 1X,
     $      F12.2, 1X, F8.2, 1X, A6 )
